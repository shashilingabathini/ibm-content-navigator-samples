...
public class EditMessagePlugin extends Plugin {

	public static String pluginId = "EditMessage";
	...
	public PluginResponseFilter[] getResponseFilters() {
		if (responseFilters == null) {
			responseFilters = new PluginResponseFilter[] { new EditMessagePluginResponseFilter() };
		}
	...
	public Class<?>[] getEventHandlers() {
		return new Class[]{EditMessagePluginEventHandler.class};
	}
}
