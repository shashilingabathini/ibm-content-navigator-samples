 ...
 */
public class CustomDefaultEmailPluginResponseFilter extends PluginResponseFilter {
		...
		if (configStr != null && configStr.length() > 0 && jsonResponse != null) {
			...
			try {
				...
				if (config != null) {
					...
					JSONObject customDefaultEmailPluginSettings = new JSONObject();
					customDefaultEmailPluginSettings.put("subject", config.get("subject"));
					customDefaultEmailPluginSettings.put("message", config.get("message"));
					pluginSettings.put(CustomDefaultEmailPlugin.pluginId, customDefaultEmailPluginSettings);
				}
			} catch (Exception e) {
