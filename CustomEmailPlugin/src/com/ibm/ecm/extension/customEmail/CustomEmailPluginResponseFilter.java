 ...
 */
public class CustomEmailPluginResponseFilter extends PluginResponseFilter {
	...
	/**
	 * Filters the response from the "getDesktop" service, inserting the <code>CustomEmail</code> plug-in setting.
	 * 
	 * @param serverType
