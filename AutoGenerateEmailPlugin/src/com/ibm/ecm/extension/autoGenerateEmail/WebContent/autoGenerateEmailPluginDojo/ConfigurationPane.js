...
define([
	...
	return declare("autoGenerateEmailPluginDojo.ConfigurationPane", [ PluginConfigurationPane, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        load: function(callback) {
            ...
            if (!this._multiValueInputPane) {
                this._createMultiValueInputPane(emailList);
            }
        },
        ...
        _onFieldChange: function() {
            ...
            this.configurationString = JSON.stringify({
                emailList: this._multiValueInputPane.getValue()
            });
        ...
        _createInputData: function(values) {
            var data = {
                ...
                "dataType": "xs:string",
                "regularExpr": "^([a-zA-Z0-9_\\-\\.]+)@([a-zA-Z0-9_\\-\\.]+)\\.([a-zA-Z]{2,5})$"
            };
            return data;
        },
